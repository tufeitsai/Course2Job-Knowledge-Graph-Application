...
class _SIMD_FP(_Test_Utility):
    ...
    def test_max_min(self, intrin):
        ...
        intrin = getattr(self, intrin)
        REMOVED_TOKENnlanes = self.nlanes//2
        ...
        for op1, op2 in cases:
            vdata_a = self.load(op1*REMOVED_TOKENnlanes)
            vdata_b = self.load(op2*REMOVED_TOKENnlanes)
        ...
        for op1, op2 in cases:
            vdata_ab = self.load([op1, op2]*REMOVED_TOKENnlanes)
