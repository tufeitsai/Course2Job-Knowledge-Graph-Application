...
class _Test_CCompilerOpt:
    ...
    def test_flags(self):
        self.expect_flags(
            ...
            armREMOVED_TOKENgcc="-mfpu=neon-fp16 -mfp16-format=ieee",
            aarch64="",
        ...
        self.expect_flags(
            "asimd",
            aarch64="",
            armREMOVED_TOKENgcc=r"-mfp16-format=ieee -mfpu=neon-fp-armv8 -march=armv8-a\+simd"
        )
        self.expect_flags(
            "asimdhp",
            aarch64_gcc=r"-march=armv8.2-a\+fp16",
            armREMOVED_TOKENgcc=r"-mfp16-format=ieee -mfpu=neon-fp-armv8 -march=armv8.2-a\+fp16"
        )
        self.expect_flags(
